                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-primary-800">
                        <thead class="bg-gray-50 dark:bg-primary-800">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Contacto / Email</th>
                                ...
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Estudios</th>
                            </tr>
                        </thead>
            ...
            <div class="md:hidden space-y-4">
                @forelse ($registrations as $reg)
                    <div class="bg-white dark:bg-primary-900 rounded-xl shadow-md p-5 border border-secondary-200 dark:border-primary-800">
                        ...
                        <div class="text-sm text-secondary-600 dark:text-secondary-300 mb-4 bg-gray-50 dark:bg-primary-800/50 p-2.5 rounded-lg border border-gray-100 dark:border-primary-700">
                            <span class="font-semibold text-xs uppercase tracking-wide text-gray-400 block mb-1">Estudios</span> 
