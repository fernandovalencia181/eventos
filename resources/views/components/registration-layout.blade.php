...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-white antialiased bg-primary-950">
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0">
            <div class="mb-6">
                <!-- Logo -->
                <a href="/" class="text-4xl font-bold text-white flex items-center gap-2">
            ...
            <div class="w-full sm:max-w-2xl mt-6 px-8 py-10 bg-primary-900 shadow-xl overflow-hidden sm:rounded-xl border border-primary-800">
                {{ $slot }}
            </div>
        </div>
    </body>
