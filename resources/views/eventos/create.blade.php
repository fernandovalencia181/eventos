                ...
                <form action="{{ route('eventos.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="nombre" value="{{ old('nombre') }}" class="mt-1 block w-full rounded-xl border-secondary-300 dark:border-primary-600 dark:bg-primary-800 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-colors py-3 px-4" placeholder="Ej: Graduación 2026">
                        ...
                        <div>
                            ...
                            <textarea name="descripcion" rows="3" class="mt-1 block w-full rounded-xl border-secondary-300 dark:border-primary-600 dark:bg-primary-800 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-colors py-3 px-4" placeholder="Detalles importantes del evento...">{{ old('descripcion') }}</textarea>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="datetime-local" name="fecha" min="{{ date('Y-m-d\TH:i') }}" value="{{ old('fecha') }}" class="mt-1 block w-full rounded-xl border-secondary-300 dark:border-primary-600 dark:bg-primary-800 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-colors dark:[color-scheme:dark] py-3 px-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="lugar" value="{{ old('lugar') }}" class="mt-1 block w-full rounded-xl border-secondary-300 dark:border-primary-600 dark:bg-primary-800 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-colors py-3 px-4" placeholder="Ej: Auditorio Principal">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label class="block text-sm font-bold text-secondary-700 dark:text-secondary-300 mb-2">Aforo Máximo del Evento</label>
                                <input type="number" name="aforo_maximo" value="{{ old('aforo_maximo') }}" class="mt-1 block w-full rounded-xl border-secondary-300 dark:border-primary-600 dark:bg-primary-800 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-colors py-3 px-4" placeholder="Ej: 500">
                                @error('aforo_maximo') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
                            </div>
                            <div>
                                <label class="block text-sm font-bold text-secondary-700 dark:text-secondary-300 mb-2">Máx. Acompañantes por Registro</label>
                                <input type="number" name="max_guests" value="{{ old('max_guests') }}" min="0" class="mt-1 block w-full rounded-xl border-secondary-300 dark:border-primary-600 dark:bg-primary-800 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-colors py-3 px-4" placeholder="Ej: 3">
                                <span class="text-xs text-secondary-500 dark:text-secondary-400 mt-1">Número máximo de invitados adicionales que un usuario puede llevar.</span>
                                @error('max_guests') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
                            </div>
                        </div>
