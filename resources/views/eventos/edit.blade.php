                ...
                <form action="{{ route('eventos.update', $evento) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        <div>
                            ...
                            <input type="text" name="nombre" value="{{ old('nombre', $evento->nombre) }}" class="mt-1 block w-full rounded-xl border-secondary-300 dark:border-primary-600 dark:bg-primary-800 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-colors py-3 px-4" required>
                        </div>

                        <div>
                            <label class="block text-sm font-bold text-secondary-700 dark:text-secondary-300 mb-2">Descripción</label>
                            <textarea name="descripcion" rows="3" class="mt-1 block w-full rounded-xl border-secondary-300 dark:border-primary-600 dark:bg-primary-800 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-colors py-3 px-4">{{ old('descripcion', $evento->descripcion) }}</textarea>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="datetime-local" name="fecha" value="{{ old('fecha', $evento->fecha) }}" class="mt-1 block w-full rounded-xl border-secondary-300 dark:border-primary-600 dark:bg-primary-800 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-colors dark:[color-scheme:dark] py-3 px-4" required>
                            </div>
                            <div>
                                <label class="block text-sm font-bold text-secondary-700 dark:text-secondary-300 mb-2">Lugar</label>
                                <input type="text" name="lugar" value="{{ old('lugar', $evento->lugar) }}" class="mt-1 block w-full rounded-xl border-secondary-300 dark:border-primary-600 dark:bg-primary-800 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-colors py-3 px-4" required>
                            </div>
                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label class="block text-sm font-bold text-secondary-700 dark:text-secondary-300 mb-2">Aforo Total</label>
                                <input type="number" name="aforo_maximo" value="{{ old('aforo_maximo', $evento->aforo_maximo) }}" class="mt-1 block w-full rounded-xl border-secondary-300 dark:border-primary-600 dark:bg-primary-800 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-colors py-3 px-4" required>
                            ...
                            <div>
                                ...
                                <input type="number" name="max_guests" value="{{ old('max_guests', $evento->max_guests ?? 3) }}" min="0" class="mt-1 block w-full rounded-xl border-secondary-300 dark:border-primary-600 dark:bg-primary-800 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500 transition-colors py-3 px-4">
