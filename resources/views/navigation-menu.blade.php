            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6 space-x-4">
                @auth
                    <div class="ml-3 relative relative group">
                        <button class="flex items-center text-sm font-medium text-primary-200 hover:text-white transition focus:outline-none">
                        ...
                        <div class="absolute right-0 mt-2 w-48 bg-primary-800 rounded-xl shadow-lg py-2 hidden group-hover:block border border-primary-700 z-50">
