        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    @auth
                        <a href="{{ route('calendario') }}" class="text-secondary-600 hover:text-primary-600 font-medium">Mi Calendario</a>
                        <a href="{{ route('mis.entradas') }}" class="text-secondary-600 hover:text-primary-600 font-medium">Mis Entradas</a>
                        <a href="{{ route('dashboard') }}" class="px-4 py-2 bg-primary-100 text-primary-700 rounded-lg hover:bg-primary-200 transition">Dashboard</a>
                    @else
                        <a href="{{ route('login') }}" class="text-secondary-600 hover:text-primary-600 font-medium">Login</a>
                        <a href="{{ route('register') }}" class="px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-500 transition">Registrarse</a>
                    @endauth
                </div>
            </div>
        </div>
